...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnSintactico = new componentes.rsbuttom.RSButtonMetro();
        ...
        jPanel1.add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 430, 180, 280));
        ...
        jScrollPane6.setViewportView(jTextAreaSintactico);

        jPanel1.add(jScrollPane6, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 430, 240, 160));

        btnSintactico.setBackground(new java.awt.Color(10, 133, 175));
        btnSintactico.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icono.nuevo.png"))); // NOI18N
        btnSintactico.setText("Analisis sintantico");
        btnSintactico.setColorBorde(javax.swing.BorderFactory.createMatteBorder(5, 5, 5, 5, new javax.swing.ImageIcon(getClass().getResource("/componentes/rsbuttom/border.png")))); // NOI18N
        btnSintactico.setColorPressed(new java.awt.Color(0, 153, 204));
        ...
        jPanel1.add(btnSintactico, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 600, 140, 90));
...
//        }
                ...
                while (true) {
                    ...
                    switch (tokens) {
                        ...
                        case ErrorIdentificadorFuncion:
                            resultado2 += "LINEA " + contador + "\n";
                            resultado2 += lexer.lexeme + ": \t  Error Funcion" + "\n";
                            a.lblMensaje1.setText("LINEA " + contador + "\n");
                        ...
                        case ErrorIdentificadorVariable:
                            resultado2 += "LINEA " + contador + "\n";
                            resultado2 += lexer.lexeme + ": \t Error Variable" + "\n";
                            a.lblMensaje1.setText("LINEA " + contador + "\n");
    ...
    private void btnSintacticoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSintacticoActionPerformed
        ...
        try {
            ...
            s.action_table();
            alertas.AlertSucess a = new AlertSucess(this, true);
            a.lblMensaje1.setText("Analisis realizado");
            a.lblMensaje2.setText("Correctamente");
            a.setVisible(true);
            jTextAreaSintactico.setText("Analisis realizado correctamente");
            
            jTextAreaSintactico.setForeground(new Color(25, 111, 61));
        } catch (Exception ex) {
            Symbol sym = s.getS();
            alertas.AlertError a = new AlertError(this, true);
            a.lblMensaje1.setText("Error de analisis");
            a.lblMensaje2.setText("Sintactico");
            a.setVisible(true);
            jTextAreaSintactico.setText("Error de sintaxis. Linea: " + (sym.right + 1) + " Columna: " + (sym.left + 1) + ", Texto: \"" + sym.value + "\"");
            jTextAreaSintactico.setForeground(Color.red);
        }
    ...
    private componentes.rsbuttom.RSButtonMetro btnSintactico;
